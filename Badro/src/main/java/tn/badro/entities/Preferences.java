...
public class Preferences {
    ...
    public Preferences(int id, String climat_pref, String country, String domain, String preferred_language, String teaching_mode, String university_type, String cultural_activities, String language_level) {
        this.id = id;
